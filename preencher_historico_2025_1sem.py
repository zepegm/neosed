...
planilha = xls("C:\\Users\\giuseppe.manzella\\OneDrive - Secretaria da Educação do Estado de São Paulo (1)\\Formandos 2025\\Médio\\Histórico 3ª Série A.xlsx") # formar conexão com a planilha
indice_planilha = 18  # nome da aba da planilha
ra_aluno = "000" + planilha.getValCell('P10', indice_planilha)[:-2].replace('.', '')  # obter o RA do aluno

def mostrar_menu():
    print("\n--- Menu de Escolha ---")
    print("1. Preencher Cabeçalho do Histórico")
    print("2. Preencher Notas do Histórico baseadas na planilha aberta")
...
def write_head():
    ...
    for aluno in alunos:
        if aluno['ra'] == ra_aluno:
            ...
            planilha.setValCell('E9', aluno['nome'], indice_planilha)  # Nome do aluno
            planilha.setValCell('G11', aluno['nascimento_data'], indice_planilha)  # Nome do aluno
            ...
            planilha.setValCell('E10', aluno_add['rg'], indice_planilha)  # RG do aluno
            planilha.setValCell('G12', info_aluno['nascimento_uf'], indice_planilha)  # UR do RG do aluno
            planilha.setValCell('P11', info_aluno['nascimento_cidade'], indice_planilha)  # UR do RG do aluno
            planilha.setValCell('P12', 'BRASIL', indice_planilha)  # UR do RG do aluno
