...
;(function ( $, window, document, undefined ) {
  ...
  ComboTree.prototype.init = function () {
    ...
    this._elemArrowBtn = $('<div id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn" type="button"><span class="fa-solid fa-chevron-down"></span></div>');
  ...
  ComboTree.prototype.createFilterHTMLForMultiSelect = function (){
    return '<input id="' + this.comboTreeId + 'MultiFilter" type="text" class="multiplesFilter" placeholder="Digite para Filtrar"/>';
  }

  ComboTree.prototype.createSelectAllHTMLForMultiSelect = function () {
    return '<label class="selectAll"><input type="checkbox" id="' + this.comboTreeId + 'SelectAll' + '">[Selecionar Tudo]</label>';
  }
  ...
  ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
    ...
    if (isThereSubs)
      itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse || collapse ? '<span class="fa-solid fa-circle-chevron-right"></span>' : '<span class="fa-solid fa-circle-chevron-down"></span>') + '</span>'; // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') + '</span>';
  ...
  ComboTree.prototype.toggleSelectionTree = function (item, direction) {
    ...
    if (direction === undefined){
      if ($(subMenu).is(':visible'))
        $(item).children('span.comboTreeParentPlus').html('<span class="fa-solid fa-circle-chevron-right"></span>'); //$(item).children('span.comboTreeParentPlus').html("+");
      else
        $(item).children('span.comboTreeParentPlus').html('<span class="fa-solid fa-circle-chevron-down"></span>'); //$(item).children('span.comboTreeParentPlus').html("&minus;");
